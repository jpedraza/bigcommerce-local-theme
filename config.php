...
$GLOBALS['TPL_CFG']['Name'] = 'everbackertest';
...
$GLOBALS['TPL_CFG']['DemoStore'] = "http://everbackertest-demo.mybigcommerce.com";

// Is theme enabled? (i.e. visible in Theme Store)
$GLOBALS['TPL_CFG']['Enabled'] = Store_Feature::isEnabled('everbackertestTheme');
